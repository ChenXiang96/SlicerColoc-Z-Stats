...
Coloc-Z-Stats is freely usable for Non-commercial purposes under (see the [Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)](https://creativecommons.org/licenses/by-nc/4.0/) for details).
